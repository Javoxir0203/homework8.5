						...
						<SwiperSlide key={testimony.id}>
							<div className='bg-[#FFF] rounded-[8px]'>
								...
								<div className='border border-[#F1F1F3] bg-[#FCFCFD] p-[15px] lg:p-[30px] rounded-bl-[8px] rounded-br-[8px] flex justify-between items-end'>
									...
									<Button label='Read More' type='button' styles='py-[14px] px-[18px] lg:py-[18px] lg:px-[24px] border border-[#F1F1F3] bg-[#F7F7F8] rounded-[8px] text-[15px] font-[500] text-[#262626] hover:bg-[#eaeaeb] transition ease-in-out duration-500' />
								</div>
							</div>
						</SwiperSlide>
					);
