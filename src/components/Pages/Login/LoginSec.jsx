...
function LoginSec({ title, des, terms, bridge, or, log }) {
			...
			<div className='bg-white rounded-[8px] p-[10px] md:p-[40px]' data-aos='zoom-in' data-aos-duration='1000' data-aos-once='true'>
				<form id='form' onSubmit={handleSubmit}>
					<div>
						...
						<div className='mb-4'>
							<Input labelFor='email' label='Email' inputType='text' inputName='email' placeholder='Enter Your email eddress' value={formData.email} onChange={handleChange} onBlur={handleBlur} error={errors.email} />
						...
						<Button label='Login' type='submit' styles='bg-[#FF9500] rounded-[10px] px-[20px] py-[18px] text-white text-[14px] font-[500] w-full' />
						<div className='flex items-center text-[#98989A] my-6 gap-3'>
							<span className='border w-full'></span>
							{or}
							<span className='border w-full'></span>
						</div>
						<Button label='Sign Up With Google' type='submit' styles='bg-[#F7F7F8] border border-[#F1F1F3] rounded-[10px] px-[20px] py-[18px] text-black text-[14px] font-[500] w-full' />
