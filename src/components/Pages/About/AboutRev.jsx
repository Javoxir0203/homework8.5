...
function AboutRev({ shape, fTitle, Title, parag }) {
	return (
			...
			<div className='bg-[#fff] rounded-[12px] p-[20px] md:p-[50px] relative' data-aos='fade-left' data-aos-duration='1000' data-aos-once='true'>
				<div className='flex flex-col md:flex-row md:justify-between md:items-center'>
					<div className='z-[20] mb-4'>
						<h2 className='font-[700] text-[35px] leading-[120%] pb-4'>
							{' '}
							<span className='text-[#FF9500]'>{fTitle}</span>
							{Title}
						</h2>
					...
					<div>
						<NavLink to='/contact'>
							<Button type='button' label='Join Now' styles='bg-[#FF9500] py-[18px] px-[24px] rounded-[8px] text-[16px] font-[600] text-white w-[120px]' />
						</NavLink>
					</div>
				</div>
