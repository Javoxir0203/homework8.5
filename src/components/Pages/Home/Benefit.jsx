	...
	return (
		<div className='w-[95%] md:w-[90%] lg:w-[80%] mx-auto mt-[50px] overflow-hidden'>
			<div className='flex flex-col lg:flex-row lg:items-center'>
				<Title title='Benefits' subTitle='Lorem ipsum dolor sit amet consectetur. Tempus tincidunt etiam eget elit id imperdiet et. Cras eu sit dignissim lorem nibh et. Ac cum eget habitasse in velit fringilla feugiat senectus in.' />
			...
			<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-[70px]'>
				{benefits.map(benefit => {
					return <BenefitCard key={benefit.num} benefitCard={benefit} />;
				})}
			</div>
		</div>
	);
...
function BenefitCard({ benefitCard }) {
	const { num, label, subLabel } = benefitCard;
