	...
	return (
		<div className='w-[95%] md:w-[90%] lg:w-[80%] mx-auto'>
			<div className='flex flex-col lg:flex-row lg:items-center'>
				<Title title='Our Testmonials' subTitle='Lorem ipsum dolor sit amet consectetur. Tempus tincidunt etiam eget elit id imperdiet et. Cras eu sit dignissim lorem nibh et. Ac cum eget habitasse in velit fringilla feugiat senectus in.' />
			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-[30px] my-[70px]'>
				{testimonies.map(testimony => {
					return <TestmonialCard key={testimony.id} textCard={testimony} />;
				})}
			</div>
		</div>
	);
...
function TestmonialCard({ textCard }) {
	...
	return (
		<div className='bg-[#FFF] rounded-[8px] benefit-card' data-aos='fade-up' data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='1000'>
			...
			<div className='border border-[#F1F1F3] bg-[#FCFCFD] p-[15px] lg:p-[30px] rounded-bl-[8px] rounded-br-[8px] flex justify-between items-end'>
				...
				<Button label='Read Full Story' type='button' styles='py-[14px] px-[18px] lg:py-[18px] lg:px-[24px] border border-[#F1F1F3] bg-[#F7F7F8] rounded-[8px] text-[15px] font-[500] text-[#262626] hover:bg-[#eaeaeb] transition ease-in-out duration-500' />
			</div>
		</div>
	);
}
