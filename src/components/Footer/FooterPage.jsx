...
function FooterPage({ imgLogo, logoAlt, mail, contact, location, title, copyRight }) {
	const listItem = [
		{
			title: 'Home',
		...
		<div>
			...
			<ul className='pt-4'>
				{navLists.map(navList => {
					return (
						<li key={navList} className='font-[500] text-[14px] text-[#59595A] mb-3 cursor-pointer transition ease-in-out duration-500 hover:translate-x-4'>
							{navList}
						</li>
					);
				})}
